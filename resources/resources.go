...
// ProcessVars returns some variables related to the processChan. Internal API!
func (obj *BaseRes) ProcessVars() (bool, *sync.Mutex) {
	return obj.processDone, obj.processLock
}
